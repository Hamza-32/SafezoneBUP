...
async function setupDatabase() {
  ...
  try {
    ...
    console.log('🔌 Connecting to MySQL server...');    connection = await mysql.createConnection({
      host: 'localhost',
      user: 'root',
    ...
    console.log('📝 Creating tables...');    // Users
    ...
    `);
    console.log('✅ Users table created');    // Emergency Reports
    await connection.execute(`
    ...
    `);
    console.log('✅ Emergency reports table created');    // Complaints
    await connection.execute(`
    ...
    `);
    console.log('✅ Complaints table created');    // Notifications
    await connection.execute(`
    ...
    `);
    console.log('✅ Notifications table created');    // Audit Logs
    await connection.execute(`
    ...
    `);
    console.log('✅ Audit logs table created');    // System Settings
    await connection.execute(`
    ...
    `);
    console.log('✅ System settings table created');    // Emergency Contacts
    await connection.execute(`
    ...
    console.log('✅ Indexes created/verified');    // Step 5: Show tables
    console.log('\n📋 Database Summary:');
    ...
    console.log('\nNext steps:');
    console.log('1. Run: node seed-simple.js (to add sample data)');
