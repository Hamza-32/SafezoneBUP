    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-[#353535]">File a Complaint</h1>
          <p className="text-[#837E6B]">Report non-emergency issues using student ID</p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                <p className="font-medium text-[#353535] mb-1">Anonymous Complaint System</p>
        ...
        <Card className="shadow-lg border-[#8C897A]/20">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-[#353535]">Complaint Details</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                />
                <p className="text-xs text-[#837E6B]">This student will be notified to verify the complaint</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-[#837E6B]" />
                  <Input
                    id="incidentDate"
                    type="date"
                    className="pl-10"
